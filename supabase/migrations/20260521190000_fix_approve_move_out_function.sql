-- 20260521190000_fix_approve_move_out_function.sql
-- Fix approve_move_out_and_reward to handle notices where property_id is null
-- by falling back to room_id or booking_id -> bookings.listing_id
