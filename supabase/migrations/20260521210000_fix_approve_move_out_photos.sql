-- 20260521210000_fix_approve_move_out_photos.sql
-- Fix the approve_move_out_and_reward function to copy photos correctly by referencing the correct columns in listing_photos.
