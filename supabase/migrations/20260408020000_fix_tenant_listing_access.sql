...
CREATE POLICY "listings_universal_tenant_access_v1"
  ...
  USING (
    ...
    -- This bypasses listing status, vacancy status, and any other public filters.
    EXISTS (
...
-- 2. Redress LISTING PHOTOS Policy (v2)
...
CREATE POLICY "listing_photos_universal_tenant_access_v1"
