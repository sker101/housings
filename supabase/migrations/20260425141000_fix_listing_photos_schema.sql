...
BEGIN
    ...
    -- First, check if the column exists and what its type is
    IF EXISTS (
        SELECT 1 
    ...
    -- 4. Fix any potential view vs table conflict for listings
    -- If listings is a view, it might be blocking updates or missing columns
    -- But since the user reported the listing WAS created, we focus on photos.
END $$;
